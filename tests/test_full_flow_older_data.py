...
print("=" * 70)
print("過去データでの完全フローテスト")
print("=" * 70)
print()

fetcher = HistoricalFetcher()

# 2024年1月1日以降のデータ (last_file_timestamp は 20251114112822)
from_date = "20240101"
to_date = "20240101"
...
try:
    ...
    print()
    if record_count > 0:
        print("[SUCCESS] 完全フロー成功！実際のJV-Dataを取得・パースできました！")
    else:
        print("[INFO] データなし（この日時以降に新しいデータがありません）")

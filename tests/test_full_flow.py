...
print("=" * 70)
print("完全なデータ取得フロー（Fetch → Parse）テスト")
print("=" * 70)
print()

print("HistoricalFetcher → ParserFactory の完全フロー")
print()

fetcher = HistoricalFetcher()

# 2024年11月1日以降のRACEデータ
from_date = "20241101"
to_date = "20241101"

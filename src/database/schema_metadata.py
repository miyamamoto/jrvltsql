...
TABLE_METADATA: Dict[str, TableMetadata] = {
    ...
    "TS_O1": {
        ...
        "purpose": "単勝・複勝・枠連オッズの時間推移を記録するテーブル。発表月日時分（HassoTime）をキーに含め複数時点のデータを保持",
        "columns": [
            ...
            {"name": "JyoCD", "type": "TEXT", "description": "競馬場コード", "example": "05", "nullable": False},
            {"name": "RaceNum", "type": "INTEGER", "description": "レース番号", "example": "11", "nullable": False},
            {"name": "HassoTime", "type": "TEXT", "description": "発表月日時分（MMDDhhmm）", "example": "06011530", "nullable": False},
    ...
    "TS_O2": {
        ...
        "purpose": "馬連オッズの時間推移を記録するテーブル。発表月日時分（HassoTime）をキーに含め複数時点のデータを保持",
        "columns": [
    ...
    "TS_O3": {
        ...
        "purpose": "ワイドオッズの時間推移を記録するテーブル。発表月日時分（HassoTime）をキーに含め複数時点のデータを保持",
        "columns": [
    ...
    "TS_O4": {
        ...
        "purpose": "馬単オッズの時間推移を記録するテーブル。発表月日時分（HassoTime）をキーに含め複数時点のデータを保持",
        "columns": [
    ...
    "TS_O5": {
        ...
        "purpose": "三連複オッズの時間推移を記録するテーブル。発表月日時分（HassoTime）をキーに含め複数時点のデータを保持",
        "columns": [
    ...
    "TS_O6": {
        ...
        "purpose": "三連単オッズの時間推移を記録するテーブル。発表月日時分（HassoTime）をキーに含め複数時点のデータを保持",
        "columns": [

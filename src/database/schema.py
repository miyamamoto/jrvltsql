...
SCHEMAS = {
    ...
    "NL_SK": """
        CREATE TABLE IF NOT EXISTS NL_SK (
            ...
            MFNum TEXT NOT NULL,
            MMNum TEXT NOT NULL,
            FFFNum TEXT NOT NULL,
            FFMNum TEXT NOT NULL,
            FMFNum TEXT NOT NULL,
            FMMNum TEXT NOT NULL,
            MFFNum TEXT NOT NULL,
            MFMNum TEXT NOT NULL,
            MMFNum TEXT NOT NULL,
            MMMNum TEXT NOT NULL,
            RecordDelimiter TEXT,
            PRIMARY KEY (KettoNum)
        )
    """,
...
STRICT_ODDS_STORAGE_TABLES = frozenset(
    {f"NL_O{index}" for index in range(1, 7)}
    | {f"RT_O{index}" for index in range(1, 7)}
    | {
...
def _verify_existing_strict_storage_targets(db: BaseDatabase) -> None:
    ...
    for target in targets:
        ...
        for table_name in STRICT_ODDS_STORAGE_TABLES:
            if target.table_exists_strict(table_name):
                verify_odds_storage_schema(target, table_name)
...
class SchemaManager:
    ...
    def create_table(self, table_name: str) -> bool:
        ...
        try:
            ...
            if table_name in STRICT_SK_STORAGE_TABLES:
            ...
            if table_name in STRICT_ODDS_STORAGE_TABLES:
                from src.importer.importer import verify_odds_storage_schema

                verify_odds_storage_schema(self.db, table_name)

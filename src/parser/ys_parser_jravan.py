"""Parser for YS record - JRA-VAN Standard compliant.
...
class YSParserJRAVAN(BaseParser):
    """Parser for YS record with JRA-VAN standard schema.
    ...
    def _define_fields(self) -> List[FieldDef]:
        ...
        return [
            ...
            FieldDef("YoubiCD", 25, 1, description="曜日コード"),
            FieldDef("<重賞案内>", 26, 118, description="<重賞案内>"),
            FieldDef("RecordDelimiter", 380, 2, description="レコード区切"),
        ]

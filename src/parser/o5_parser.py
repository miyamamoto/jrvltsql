...
class O5Parser(BaseParser):
    ...
    def _define_fields(self) -> List[FieldDef]:
        ...
        return [
            ...
            FieldDef("HatsubaiFlag7", 39, 1, description="発売フラグ　3連複"),
            FieldDef("SanrenfukuOddsBlock", 40, 15, description="<3連複オッズ>"),
            FieldDef("SanrenfukuHyosuTotal", 12280, 11, description="3連複票数合計"),

"""Parser for O5 record - JRA-VAN Standard compliant.
...
class O5ParserJRAVAN(BaseParser):
    """Parser for O5 record with JRA-VAN standard schema.
    ...
    def _define_fields(self) -> List[FieldDef]:
        ...
        return [
            ...
            FieldDef("発売フラグ　3連複", 39, 1, description="発売フラグ　3連複"),
            FieldDef("<3連複オッズ>", 40, 15, description="<3連複オッズ>"),
            FieldDef("3連複票数合計", 12280, 11, description="3連複票数合計"),
            FieldDef("RecordDelimiter", 12291, 2, description="レコード区切"),
        ]

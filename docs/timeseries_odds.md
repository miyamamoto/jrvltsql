...
| --- | --- | --- |
| SQLite に単複枠・馬連の過去時系列を入れる | `quickstart.bat` で時系列オッズ取得を選択、`quickstart.bat --yes --include-timeseries`、または `jltsql realtime odds-timeseries --db sqlite` | JRA-VAN 側に残っている約1年分の `TS_O1` / `TS_O2` |
